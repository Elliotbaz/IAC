...
(
    ...
    echo -e "Web browser: ${GREEN}\e]8;;https://${pubip}:${PORT}\ahttps://${pubip}:${PORT}\e]8;;\a${NC} (you can accept the security exception as there is no SSL certificate installed) – or –"
    echo
